<HTML>
<HEAD>
<script type="text/javascript" src="https://www.2checkout.com/checkout/
api/2co.min.js"></script>
...
<tr><td>Card Number</td><td><input type="text" size="20" autocomplete="off"
id="card-number"></td></tr>
<tr><td>CVC</td><td><input type="text" size="4" autocomplete="off"
id="card-cvc"></td></tr>
<tr><td>Full Name</td><td><input type="text" id="name" size="80"
autocomplete="on"></td></tr>
<tr><td>Expiration (MM/YYYY)</td><td><input type="text" size="2"
id="card-expiry-month"><input type="text" size="4" id="card-expiry-year"></td></tr>
<tr><td>Amount to Pay: </td><td><?php echo $cartamount; ?></td></tr>
<tr><td colspan="2" align="center"><input type="submit" name="submit"
value="Submit" onclick="formSubmit()">
</table>
</form>
</BODY>
</HTML>