...
<body>
<form name="signup_form" action="addcustomer.php" 
...
<table border="0" cellspacing="1" cellpadding="3">
	...
	<tr>
		<td>Email Address: </td>
		<td>
			<input size="20" type="text" name="emailaddress" >
	...
	<tr>
		...
		<td><input size="20" type="password" name="repassword">
	    <span id="repasswdmsg"></span></td>
	</tr>
	<tr>
		<td>Complete Name </td>
		<td><input size="50" type="text" name="complete_name" >
			<span id="usrmsg"></span></td>
	</tr>
	<tr>
		<td>Address: </td>
