...
<tr><td colspan="2" align="center">Your information available with us:</
td></tr>
...
<tr><td></td><td><input size="80" type="text" name="address2" value="<?php
echo $address_line2; ?>"></td></tr>
<tr><td>City: </td><td><input size="30" type="text" name="city"
value="<?php echo $city; ?>"></td></tr>
<tr><td>State: </td><td><input size="30" type="text" name="state"
value="<?php echo $state; ?>"></td></tr>
<tr><td>Country: </td><td><input size="30" type="text" name="country"
value="<?php echo $country; ?>"></td></tr>
<tr><td>Zip Code: </td><td><input size="20" type="text" name="zipcode"
...
<tr><td><input type="submit" name="submit" value="Supply Payment
Information"></td><td>
